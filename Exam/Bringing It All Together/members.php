...
if (isset($_GET['view'])) {
    ...
    echo "<a class='button'
     href='messages.php?view=$view_html_entities'>
...
while ($row = $stmt->fetch()) {
    ...
    echo "<li>
          <a href='members.php?view=$rowuser_html_entities'>
                                    $rowuser_html_entities</a>";
    $follow = "follow";

    $stmt2 = $pdo->prepare('SELECT * FROM friends 
    ...
    if (!$t1)
        echo " [<a href='members.php?add=$rowuser_html_entities'>
                                         $follow</a>]";
    else
        echo " [<a href='memebrs.php?remove=$rowuser_html_entities'>
                                         drop</a>]";
}
?>
