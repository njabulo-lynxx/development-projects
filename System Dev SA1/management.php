        ...
        try {
            ...
            if (!empty($_POST['delete_id'])) {
                ...
                if ($stmt->execute([$delete_id])) {
                    $message = "<p style='color:green;'>Student deleted successfully.</p>";
                } else {
                    $message = "<p style='color:red;'>Delete failed.</p>";
                }
            }
            // Update action
            ...
            // Create action (default)
                ...
                if ($stmt->execute([$full_name, $student_id, $email, $dob, $course, $year, $enrolment_date, $academic_status])) {
                    $message = "<p style='color:green;'>Student registered successfully!</p>";
                } else {
                    $message = "<p style='color:red;'>Error: could not insert student.</p>";
                }
            }
        } catch (Exception $e) {
    ...
    <form method="post" action="management.php" novalidate>
        <fieldset>
            ...
            <div class="registration-form">
                ...
                <input type="text" id="student_id" name="student_id" required pattern="\S+" aria-required="true" 
                ...
                <?php foreach ($students as $s): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="container">
                                <a href="registrationPDF.php?MST_ID=<?php echo $data_row['user_ID']; ?>&ACTION=VIEW" 
                                    class="btn btn-info"><i class="fa fa-file-pdf-o"></i>
                                     - View PDF - </a> &nbsp;&nbsp; 
	                            <a href="registrationPDF.php?MST_ID=<?php echo $data_row['user_ID']; ?>&ACTION=DOWNLOAD" 
