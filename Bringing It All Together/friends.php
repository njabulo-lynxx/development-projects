...
if ($view === $user) {
    ...
    $name1 = "<a href='members.php?view=$view_html_entities'>
              $view_html_entities</a>'s";
...
if (sizeof($mutual)) {
    ...
    foreach ($mutual as $friend) {
        ...
        echo "<li><a href='memebrs.php?view=$fr_html_entities'>
               $fr_html_entities</a>";
    }
    echo "</ul>";
    $friends = TRUE;
...
if (sizeof($followers)) {
    echo "<span class='subhead'>$name2 follwers</span><ul>";
    foreach ($followers as $friend)
        $fr_html_entities = htmlentities($friend);
        echo "<li><a href='members.php?view=$fr_html_entities'>
              $fr_html_entities</a>";
    echo "</ul>";
    $friends = TRUE;
}
